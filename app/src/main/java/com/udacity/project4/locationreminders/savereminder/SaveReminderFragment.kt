...
class SaveReminderFragment : BaseFragment() {
    ...
    private var currentGeofenceData: ReminderDataItem? = null
    ...
    override fun onRequestPermissionsResult(
        ...
        if (permissions.isEmpty() || grantResults[LOCATION_PERMISSION_INDEX] == PackageManager.PERMISSION_DENIED || (requestCode == REQUEST_FOREGROUND_AND_BACKGROUND_PERMISSION_RESULT_CODE && grantResults[BACKGROUND_LOCATION_PERMISSION_INDEX] == PackageManager.PERMISSION_DENIED)) {
            Snackbar.make(
    ...
    private fun addGeofence(reminderDTO: ReminderDTO) {
        val geofence = Geofence.Builder()
            ...
            .setCircularRegion(reminderDTO.latitude!!, reminderDTO.longitude!!, 100f)
        ...
        geofencingClient.addGeofences(geofencingRequest, geofencePendingIntent).run {
            ...
            addOnFailureListener {
                Log.d(TAG, "failure while adding geofence")
            }
        }
    }
